...
;; What follows is code written by Nathan Schleicher to make it easy to
;; get a new random state with a given seed for a project to generate
;; Legend of Zelda-like overworlds
(defun set-random-seed (seed)
  (setf *random-state* (make-random-object :state (init-random-state seed))))
